...
<!--                                </select>-->
<!--                            </div> -->
<!--                            <div class="element elCount flexType2">-->
<!--                                <p class="notmust"></p>-->
<!--                                <p class="title">수량</p>-->
...
<!--                        </div>-->
<!--                    </div>-->
                    <div class="element goods_boxj3v ">
                        <div class="upside flexType2">
                            <p class="must"></p>
                            <p class="title">제품추가</p>
                            <button type="button" class="btnType1" name="addGoods" onclick="pop_addProduct();">제품추가</button>
                        </div>
                        <div class="downside flexType2">
                            <p class="notmust"></p>
                            <p class="title"></p>
                            <div class="appendArea ">
                                <div class="dataBox flexType3-1">
                                    <p class="data">우엉혼합물 1개</p>
                                    <i class="fa-solid fa-xmark"></i>
                                </div>
                                <div class="dataBox flexType3-1">
                                    <p class="data">우엉혼합물 1개</p>
                    ...
                    <div class="goods_boxt6r cover_boxh1t" name="coverBox" id="cover_box" >
                        <div class="element flexType2 oneCover" name="oneCover" id="">
                            <p class="notmust"></p>
                            <p class="title">부자재</p>
                            ...
                            <button type="button" class="btnType3 removeBtn" name="removeCover" style="display: none;">
