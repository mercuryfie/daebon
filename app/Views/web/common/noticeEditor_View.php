...
<script src="<?=URL_COMMON_ASSETS?>/noticeEditor_Do.js?rnd=<?=rand();?>"> </script>

<script>
</script>
<section class="merright">
    <input type="hidden" class="" id="bcode" name="bcode" data-cd="" value="<?=$body['bcode'];?>">
...
<!--                    </label>-->
                <div class="selBox flexType2">
                    <select name="is_fixed" id="is_fixed" class="inputBorder mr10" required>
                        ...
                        <option value="0" <?= $body['is_Fix'] == 0 ? 'selected' : '' ?>>일반</option>
                        <option value="1" <?= $body['is_Fix'] == 1 ? 'selected' : '' ?>>공지</option>
                    </select>
                    <select name="is_notice" id="is_notice" class="inputBorder mr10" required>
                        <option value="" disabled>전광판 노출</option>
                        <option value="0" <?= $body['is_Notice'] == 0 ? 'selected' : '' ?>>안 함</option>
                        <option value="1" <?= $body['is_Notice'] == 1 ? 'selected' : '' ?>>노출</option>
                    </select>
...
<!--                        </label>-->
                ...
                <div class="titleBox">
                    <input type="search" placeholder="제목을 입력하십시오" class="title" id="n_title" name="n_title" value="<?=$body['b_title'];?>">
                </div>
...
<!--                </label>-->
            ...
            <div class="area lastBox ">
                ...
                <button type="button" id="submit_btn" name="submit_btn" class="btnType2" onclick="Mod_Content();">확인</button>
