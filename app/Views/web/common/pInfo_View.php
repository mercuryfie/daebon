...
<section class="merright">
    <div class="p_info_wrap">
        <div class="p_info_inner">
            <h3>개인정보처리방침</h3>
            <p class="desc">
                '농업회사법인 대본주식회사'은 (이하 '회사'는) 고객님의 개인정보를 중요시하며, "정보통신망 이용촉진 및 정보보호"에 관한 법률을 준수하고 있습니다.
                회사는 개인정보취급방침을 통하여 고객님께서 제공하시는 개인정보가 어떠한 용도와 방식으로 이용되고 있으며, 개인정보보호를 위해 어떠한 조치가 취해지고 있는지 알려드립니다.
                회사는 개인정보취급방침을 개정하는 경우 웹사이트 공지사항(또는 개별공지)을 통하여 공지할 것입니다.
            <p class="title">■ 수집하는 개인정보 항목 </p>
            <p class="desc ">
                회사는 회원가입, 상담, 서비스 신청 등등을 위해 아래와 같은 개인정보를 수집하고 있습니다.
            </p>
            <p class="desc">
                ο 수집항목 : 이름 , 로그인ID , 비밀번호 , 휴대전화번호 , 서비스 이용기록 , 접속 로그 , 접속 IP 정보<br>
            ...
            <p class="title">■ 개인정보의 파기절차 및 방법</p>
            <p class="desc ">
            ...
            <p class="title">■ 개인정보 자동수집 장치의 설치, 운영 및 그 거부에 관한 사항</p>
            <p class="desc ">
            ...
            <p class="desc ">
                ...
                개인정보관리책임자 성명 : 김익중 <br>
                대표번호 : 1899-7240<br>
                이메일 : kij4490@naver.com<br><br>

                귀하께서는 회사의 서비스를 이용하시며 발생하는 모든 개인정보보호 관련 민원을 개인정보관리책임자 혹은 담당부서로 신고하실 수 있습니다. 회사는 이용자들의 신고사항에 대해 신속하게 충분한 답변을 드릴 것입니다.

                <br><br>기타 개인정보침해에 대한 신고나 상담이 필요하신 경우에는 아래 기관에 문의하시기 바랍니다.<br><br>
