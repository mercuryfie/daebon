        ...
        <div class="areaBox area_boxm9k ">
            <div class="outerBox flexType3">
                ...
                <div class="right flexType1">
                    <button type="button" class="btnType3 ddBtn"> <i class="fa-solid fa-angle-down"></i></button>
                </div>
            </div>
                        ...
                        <div class="searchMate_boxx21 flexCol " name="">
                            <div class="copyArea copyArea1 flexType2 mr10">
                                <div class="keyIn flexType2">
                                    <input type="search" class="copySearch" id="txt_product" name="txt_product" placeholder="입력 후 엔터" data-code="">
                            ...
                            <div class="flexCol">
                                <div class="copyArea copyArea2" name="add_material" id="add_material">
                                </div>
                                <div class="copyArea copyArea3 tagBox" name="tag_meterial" id="tag_meterial">
