<div class="addOrder_wrapiaj" id="addOrder_wrap" name="" style="">
    <div class="addOrder_conrlo">
        <div class="padding_area">
            <p class="head_title" id="">주문등록</p>
            <i class="fa-solid fa-xmark " id="Xbtn" name="Xbtn"></i>

            <div class="area area2 flexType2">
                <p class="category">상품선택</p>
                <input type="search" name="add1" id="" placeholder="예:우엉차" class="inputType220 mr10">
                <button type="button" class="btnType3" onclick="">검색</button>
            </div>
...
<!--            </div>-->
            ...
            <div class="area area6 flexType2">
                <p class="category"></p>
                <button type="button" class="btnType3" onclick="">배송지선택</button>
            </div>
