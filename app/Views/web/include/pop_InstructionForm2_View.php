        ...
        <table class="odRoast_Table ins_form_table">
            <thead>
                ...
                <tr>
                    ...
                    <td class="row row3 twnw ttl" colspan="">기본수량</td>
                    <td class="row row3" colspan="2"><?=$body['info_arr']['quantity']?> 개</td>
                </tr>
                <tr>
                    <td class="row row3 twnw ttl" colspan="">제조/공급사</td>
...
<!--                <td class="row row4 ttl" colspan="2">부자재</td>-->
...
<!--                <td class="row row2 tww" colspan="">--><?php //=$d['material'];?><!--</td>-->
                <td class="row row2 tww" colspan="3"><?=$d['material'];?></td>
                <td class="row row2" rowspan=""><?=$d['worker'][0]['name'] ?? '-'?></td>
        <?}?>
            </tr>
            <tr>
                <td class="row row1" colspan="5">-</td>
                <td class="row row3 twnw" colspan="">기본수량</td>
