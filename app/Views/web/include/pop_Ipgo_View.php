<div class="ipgo_wrapdej" id="ipgoWrap"  name="" style="">
    <input type="hidden" id="pop_mtcode" name="pop_mtcode" />
...
<!--                <select name="mtunit" id="mtunit" class="inputType220">-->
...
<!--            </div>-->
            ...
            <div class="area lastArea mt20 flexType5">
                ...
                <button type="button" class="btnType2" id="btn_income">확인</button>
