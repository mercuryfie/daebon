                 ...
                 <div class="left ">
                     <div class="area area1 ">
                         <div class="left1">
                             ...
                             <p class="text text2"><?=$body['info']['r_city_gun_gu']?> <?=$body['info']['r_dong']?></p>
                         </div>
                     ...
                     <div class="area area2 ">
                         <p class="text"> <?=$body['info']['pname']?></p>
                     <div class="area area2  ">
<!--                         <p class="text mr10"> --><?php //=$body['pname']?><!--<br>--><?php //=$body['pcnt']?><!--개</p>-->
<!--                         <p class="text"> --><?php //=$body['pcnt']?><!--</p>-->
                     </div>
