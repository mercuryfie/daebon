...
<script src="<?=URL_COMMON_ASSETS?>/halfList_Do.js?rnd=<?=rand();?>"> </script>
            ...
            <div class="area area2 flexType2">
                <table class="prod_list_table">
                    ...
                    <tr>
                        ...
                        <th class="ltThead">무게/수량</th>

                        <th class="ltThead">작업자</th>
                        <th class="ltThead">외포장</th>
                    ...
                    <tr>
                        ...
                        <td class="ltThead">
                            <button type="button" class="btn_gray " name="btn_add" data-code="">
                                <i class="fa-solid fa-plus"></i>
                            </button>
                        </td>
                        <td class="ltThead">
                            <button type="button" class="btn_gray" name="btn_more" data-code="" onclick="go_halfListLog();">
                    ...
                    <tr>
                        <td class="ltThead">12342134</>
                        <td class="ltThead">우엉 원물</td>
                        <td class="ltThead">100g</td>
