$(document).ready(function() {
    ...
    $(document).on('click','a[name="view_production"]',function(){
        ...
        $.each(arr.list, function (index, el) {
            ...
            html += `
                <tr>
                    ...
                    <td class="ltTbody"><a href="javascript:void(0):" name="view_production" data-code="${el.gicode}" data-nd="${el.prcode}" style="cursor: pointer;">${el.gicode}</a></td>
